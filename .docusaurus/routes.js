...
export default [
  ...
  },
  {
    ...
    component: ComponentCreator('/knowledgebase/docs', '9c9'),
    routes: [
      {
      ...
      {
        path: '/knowledgebase/docs/Backend/Python Backend/Python ORM/Delete record',
        component: ComponentCreator('/knowledgebase/docs/Backend/Python Backend/Python ORM/Delete record', '087'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
      ...
      {
        path: '/knowledgebase/docs/Backend/Python Backend/Python ORM/Insert Data',
        component: ComponentCreator('/knowledgebase/docs/Backend/Python Backend/Python ORM/Insert Data', 'fbb'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
      ...
      {
        path: '/knowledgebase/docs/Backend/Python Backend/Python ORM/Query Table',
        component: ComponentCreator('/knowledgebase/docs/Backend/Python Backend/Python ORM/Query Table', 'f3c'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
      ...
      {
        path: '/knowledgebase/docs/Backend/Python Backend/Python ORM/Update Data',
        component: ComponentCreator('/knowledgebase/docs/Backend/Python Backend/Python ORM/Update Data', 'bf2'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
